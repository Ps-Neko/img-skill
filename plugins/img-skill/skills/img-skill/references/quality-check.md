...
- **Account-observed pattern / 계정 관찰 패턴:** 승인된 공개 게시물 연구에서 출력 조건, 보존 우선, 관계형 구성, 제작 동작, 역할·면적 기반 색, 구성적 타이포그래피, 표적 제한이 관찰되었다. 이는 계정 소유자의 의도나 공식 채점법을 뜻하지 않는다.
...
- [ ] 명시적 보존 요구를 보조 스타일보다 먼저 두었다. 충돌을 드러내고 **must-keep → purpose → supporting style** 우선순위로 해결했으며 선택한 해결을 밝혔다.
